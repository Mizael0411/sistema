<img src="https://i.redd.it/zxz23b6dj78f1.gif" width="200">
...
O controle de animais, adoções, doações e lares temporários era feito manualmente, o que gerava erros, lentidão no acesso aos dados e dificuldade na geração de relatórios.

## Objetivo do sistema

Centralizar e informatizar o cadastro e o controle de:
- Animais (dados gerais, vacinação, histórico veterinário)
- Lares temporários
- Adoções
- Doações recebidas
- Produtos/insumos comprados
- Relatórios financeiros e administrativos (exportados em formato de planilha)
...
- **RF07** - Edição e exclusão de qualquer registro
- **RF08** - Controle de acesso via login
- **RF09** - Relatório financeiro (doações x gastos)
- **RF10** - Relatório de animais e adoções
- **RF11** - Exportação de relatórios em formato de planilha
...
- Plataforma: aplicação desktop (sem interface web)
- Suporte a no mínimo 3 usuários simultâneos
...
- Luna Osti de França
- Maria Luiza Ayumi Saito Yoshiura
- Maria Rita Campana Peixoto
- Mizael Augusto Soares Oliveira
